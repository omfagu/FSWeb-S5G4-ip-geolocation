...
ipAdresimiAl();
console.log("IP ADRES\u0130M = ".concat(benimIP));
...
ipAdresimiAl().then(function () {
  function yeniCard(data) {
    ...
    ulke.textContent = "".concat(data.ülke, " (").concat(data.ülkeKodu, ")");
    cardInfo.append(ulke);
    var enlemBoylam = document.createElement('p');
    enlemBoylam.textContent = "Enlem : ".concat(data.enlem, " Boylam : ").concat(data.boylam);
